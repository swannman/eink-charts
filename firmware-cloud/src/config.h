...
#endif
// Cloudflare Worker that holds the latest encrypted bundle. Pi pushes here
// every 4 min via systemd timer; X3 pulls here from any network.
#ifndef DEFAULT_WORKER_URL
#define DEFAULT_WORKER_URL "https://dashboard.contexa.net/bundle"
#endif
// Bearer token for the Worker. Empty until provisioned via NVS at runtime
// or overridden in secrets.h.
